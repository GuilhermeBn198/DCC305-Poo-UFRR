...
public class Cachorro {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Temos em nosso banco um total de 5 raças de cachorros: Pastor Alemao, Pitbull, Husky Siberiano, Pinscher e Dachshund");
        pulaL();
        pulaL();
        System.out.println(
        ...
        if (raca.getFocinho().equals(2) && raca.getPelagem().equals(1) && raca.getComportamento().equals(2)
        ...
        if (raca.getFocinho().equals(1) && (raca.getPelagem().equals(1)
        ...
        if (raca.getFocinho().equals(3) && (raca.getPelagem().equals(1) || raca.getPelagem().equals(2))
